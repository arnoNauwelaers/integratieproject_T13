    ...
    public class ChartManager
    {
        ...
        public void CreateStandardChartsIfNotExists()
        {
            ...
            if (standardCharts.Count < amountStandardCharts && chartRepository.ReadStandardCharts().Count < amountStandardCharts)
            {
                ...
                Chart trendingOrganizationWeek = new Chart() { PageBound = true, ChartType = ChartType.bar, ChartValue = ChartValue.trendOrganizations, FrequencyType = DateFrequencyType.weekly };
                Chart trendingOrganizationMonth = new Chart() { PageBound = true, ChartType = ChartType.bar, ChartValue = ChartValue.trendOrganizations, FrequencyType = DateFrequencyType.monthly };
